					...
					<tr>
						...
						<td>
							...
							<div class="btn-group">
								...
								<div class="px-1" >
									<a href="index.php?action=editar&id=<?php echo $value["id"];?>" class="btn btn-warning">Editar <i class="far fa-edit"></i></a><!-- En este caso estoy enviando el ID como una variable GET es decir atraves de la URL, una forma mas segura es hacerlo con un formulario POST-->
								</div>
									<form method = "post"> <!--En este caso envio la info con un formulario POST-->
										
										<input type="hidden" value = "<?php echo $value["id"];?>" name="registroEliminar">
